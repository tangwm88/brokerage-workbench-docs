...
sections_left = [
    {
        ...
        'sec': 'sec1',
        'models': [
            ('📐 资管产品设计原子模型', '7维', '产品类型/配置结构/风险收益/期限安排/规模目标/费率结构/投资限制'),
            ('📊 同业比对原子模型', '6维', '产品池/比对维度/业绩归因/配置差异/费率差异/定价建议'),
            ('🧮 收益测算原子模型', '6维', '预期收益/回撤压力/场景模拟/敏感性/流动性/容量测算'),
            ('👤 投资经理准入原子模型', '7维', '管理规模/投资业绩/风险控制/投资策略/团队实力/合规记录/经营财务'),
        ]
    },
    {
        'title': '资金募集原子模型',
        'sec': 'sec2',
        'models': [
            ('👥 客户分类原子模型', '6维', '个人分层/机构分类/资金性质/投资经验/风险承受/投资偏好'),
            ('🎯 客户与产品匹配规则原子模型', '6项', '合规匹配/投资能力/风险偏好/投资意愿/投资期限/集中度'),
            ('📝 内容推介生成原子模型', '7项', '合规宣传/产品特征/风险揭示/业绩展示/适配说明/发行安排/冷静期提示'),
            ('🏦 渠道准入原子模型', '6情形', '已准入银行/新拓展银行/银行理财子/三方财富/互联网平台/协议签署'),
        ]
    },
    {
        'title': '投资运作原子模型',
        'sec': 'sec3',
        'models': [
            ('📋 投资运作动作原子模型', '5动作', '投资启动/交易执行/持仓管理/估值核算/信息披露'),
            ('⚠️ 风险监测原子模型', '5维', '净值回撤/集中度/流动性/合规风控/信用风险+处理机制'),
            ('🔧 持续服务原子模型', '6项', '定期报告/净值波动/重大变化/大额赎回/客户咨询/投诉处理'),
        ]
    },
]
...
sections_right = [
    {
        ...
        'sec': 'sec4',
        'models': [
            ('🛡️ 资管产品合规模型', '7项', '宣传合规/合格投资者/风险揭示/适当性匹配/购买回访/信息披露/投资运作合规'),
            ('👁️ 监督模型', '7项', '进度管控/质量检查/合规留痕/异常报警/推进督促/计量核算/独立监督'),
            ('⚖️ 员工贡献计量分配原子模型', '8类角色', '发起人/设计师/销售人/投资经理/筛选评估/投后管理/协作支持/平台运营+递延约束'),
            ('📈 总绩效计量原子模型', '5类收入', '管理费20%+补贴10%/交易佣金/超额报酬20%+补贴10%/认申购费100%/销售服务费50%'),
            ('💰 准入标准费率原子模型', '按产品', '权益类管理费1.0-1.5%/固收类0.5-0.75%/混合类0.8-1.2%/FOF0.8-1.0%/超额2-4%'),
